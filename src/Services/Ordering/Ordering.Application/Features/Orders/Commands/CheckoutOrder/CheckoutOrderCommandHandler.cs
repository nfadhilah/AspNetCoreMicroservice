...
namespace Ordering.Application.Features.Orders.Commands.CheckoutOrder
{
  public class CheckoutOrderCommandHandler : IRequestHandler<CheckoutOrderCommand, int>
  {
    ...
    {
      var email = new Email {To = order.EmailAddress, Body = $"Order was created.", Subject = "Order Created"};
      ...
      {
        _logger.LogError($"Order {order.Id} failed do to an error with the mail service: {e.Message}");
      }
    }
  }
}